...
//		List<TestFitnessFunction> goals = getGoals(true);
		...
		else if (Properties.ALGORITHM == Properties.Algorithm.DYNAMOSA)
			LoggingUtils.getEvoLogger().info("* Total number of test goals for DYNAMOSA: {}", fitnessFunctions.size());
